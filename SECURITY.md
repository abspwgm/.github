...
[absolute-standard](https://github.com/abspwgm/absolute-standard/security/advisories/new)
...
[absolute-standard](https://github.com/abspwgm/absolute-standard): clause 6 and
[`security/BASELINE.md`](https://github.com/abspwgm/absolute-standard/blob/main/security/BASELINE.md)
set a seven-layer baseline from L1 source to L7 operations, and
[`conformance/check.py`](https://github.com/abspwgm/absolute-standard/blob/main/conformance/check.py)
