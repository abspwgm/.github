...
`absolute-standard`, and `.absolute/policy.yml` declares `standard_version`.
...
```sh
python3 /path/to/absolute-standard/conformance/check.py --repo .
```
...
[std]: https://github.com/abspwgm/absolute-standard
